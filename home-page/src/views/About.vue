          ...
          <div class="box-3-2">
            ...
            <div class="content">
              <h3>我是誰?</h3>
                <p>
                  嗨! 我是Ray，也可以叫我爽爽，<br>
                  土生土長的彰化人，別問彰化有什麼好玩的，<br>我只會告訴你有很多控肉飯可以吃。
                </p>
                <p>
                  本質是個前端工程師，卻又略懂不少其他領域的技能，<br>
                  例如：3D建模、3D列印、遊戲開發、水冷PC主機裝修、維修改裝機車電系與配備 等等奇怪的技能。
                  
                </p>

              <h3>學歷</h3>
                <p>
                  畢業於人稱北科高中的 <span>國立台北科技大學 資訊工程學系</span>。<br>
                  畢業於 <span>國立彰化師大附屬高級工業職業學校 資訊科</span>。
                </p>
