...
var showMsgBtn = function (scene, UIScene, target) {
  ...
  // UIScene.dialogBtn.x = target.x + (target.width>20?target.width/2:0);
  // UIScene.dialogBtn.y = target.y - 32;

  // UIScene.dialogBtn.x = config.width / 2;
  // UIScene.dialogBtn.y = config.height / 2;
