class GameHome extends Phaser.Scene{
    ...
    create(){
        ...
        this.PlayButton = this.add.sprite(config.width / 2, config.height / 2 + 50, 'GameButton').setInteractive().setOrigin(0.5);
        this.anims.create({
            key: "ButtonShow",
        ...
        this.PlayText = this.add.bitmapText( config.width / 2, config.height / 2 + 50, "pixelFont",  "Play", 10).setOrigin(0.5,0.5);
