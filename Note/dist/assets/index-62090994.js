 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const My="FirebaseError";class rn extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=My,Object.setPrototypeOf(this,rn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Ii.prototype.create)}}class Ii{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},r=`${this.service}/${e}`,i=this.errors[e],o=i?Oy(i,s):"Error",a=`${this.serviceName}: ${o} (${r}).`;return new rn(r,a,s)}}function Oy(t,e){return t.replace(Ly,(n,s)=>{const r=e[s];return r!=null?String(r):`<${s}?>`})}const Ly=/\{\$([^}]+)}/g;function Br(t,e){if(t===e)return!0;const n=Object.keys(t),s=Object.keys(e);for(const r of n){if(!s.includes(r))return!1;const i=t[r],o=e[r];if(Sl(i)&&Sl(o)){if(!Br(i,o))return!1}else if(i!==o)return!1}for(const r of s)if(!n.includes(r))return!1;return!0}function Sl(t){return t!==null&&typeof t=="object"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qr=new Map,Ho=new Map;function Rv(t,e){try{t.container.addComponent(e)}catch(n){An.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function en(t){const e=t.name;if(Ho.has(e))return An.debug(`There were multiple attempts to register component ${e}.`),!1;Ho.set(e,t);for(const n of qr.values())Rv(n,t);return!0}function Qs(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lv=Nv;function Kh(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:jo,automaticDataCollectionEnabled:!1},e),r=s.name;if(typeof r!="string"||!r)throw Qt.create("bad-app-name",{appName:String(r)});if(n||(n=Ny()),!n)throw Qt.create("no-options");const i=qr.get(r);if(i){if(Br(n,i.options)&&Br(s,i.config))return i;throw Qt.create("duplicate-app",{appName:r})}const o=new jy(r);for(const c of Ho.values())o.addComponent(c);const a=new Ov(n,s,o);return qr.set(r,a),a}function zh(t=jo){const e=qr.get(t);if(!e&&t===jo)return Kh();if(!e)throw Qt.create("no-app",{appName:t});return e}function At(t,e,n){var s;let r=(s=kv[t])!==null&&s!==void 0?s:t;n&&(r+=`-${n}`);const i=r.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const a=[`Unable to register library "${r}" with version "${e}":`];i&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),i&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),An.warn(a.join(" "));return}en(new Lt(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const af=new Map;function cf(t,e){const n=Ti(t);lf(n,e),ow(n,e)}function lf(t,e){const n=af.get(t);if(n)for(const s of n)s(e)}function ow(t,e){const n=aw();n&&n.postMessage({key:t,fid:e}),cw()}let vn=null;function aw(){return!vn&&"BroadcastChannel"in self&&(vn=new BroadcastChannel("[Firebase] FID Change"),vn.onmessage=t=>{lf(t.data.key,t.data.fid)}),vn}function cw(){af.size===0&&vn&&(vn.close(),vn=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lw="firebase-installations-database",uw=1,Dn="firebase-installations-store";let po=null;function $a(){return po||(po=Hh(lw,uw,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Dn)}}})),po}async function jr(t,e){const n=Ti(t),r=(await $a()).transaction(Dn,"readwrite"),i=r.objectStore(Dn),o=await i.get(n);return await i.put(e,n),await r.done,(!o||o.fid!==e.fid)&&cf(t,e.fid),e}async function uf(t){const e=Ti(t),s=(await $a()).transaction(Dn,"readwrite");await s.objectStore(Dn).delete(e),await s.done}async function bi(t,e){const n=Ti(t),r=(await $a()).transaction(Dn,"readwrite"),i=r.objectStore(Dn),o=await i.get(n),a=e(o);return a===void 0?await i.delete(n):await i.put(a,n),await r.done,a&&(!o||o.fid!==a.fid)&&cf(t,a.fid),a}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hr="analytics",Rw="firebase_id",Mw="origin",Ow=60*1e3,Lw="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",pf="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class n0{constructor(e){this.app=e}_delete(){return delete As[this.app.options.appId],Promise.resolve()}}let As={},Vl=[];const $l={};let mo="dataLayer",s0="gtag",Ul,vf,Bl=!1;function r0(){const t=[];if(Ty()&&t.push("This is a browser extension environment."),by()||t.push("Cookies are not available."),t.length>0){const e=t.map((s,r)=>`(${r+1}) ${s}`).join(" "),n=lt.create("invalid-analytics-context",{errorInfo:e});tt.warn(n.message)}}function i0(t,e,n){r0();const s=t.options.appId;if(!s)throw lt.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)tt.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw lt.create("no-api-key");if(As[s]!=null)throw lt.create("already-exists",{id:s});if(!Bl){Pw(mo);const{wrappedGtag:i,gtagCore:o}=Bw(As,Vl,$l,mo,s0);vf=i,Ul=o,Bl=!0}return As[s]=t0(t,Vl,$l,e,Ul,mo,n),new n0(t)}function o0(t=zh()){t=ht(t);const e=Qs(t,Hr);return e.isInitialized()?e.getImmediate():a0(t)}function a0(t,e={}){const n=Qs(t,Hr);if(n.isInitialized()){const r=n.getImmediate();if(Br(e,n.getOptions()))return r;throw lt.create("already-initialized")}return n.initialize({options:e})}function c0(t,e,n,s){t=ht(t),Zw(vf,As[t.app.options.appId],e,n,s).catch(r=>tt.error(r))}const ql="@firebase/analytics",jl="0.9.0";function l0(){en(new Lt(Hr,(e,{options:n})=>{const s=e.getProvider("app").getImmediate(),r=e.getProvider("installations-internal").getImmediate();return i0(s,r,n)},"PUBLIC")),en(new Lt("analytics-internal",t,"PRIVATE")),At(ql,jl),At(ql,jl,"esm2017");function t(e){try{const n=e.getProvider(Hr).getImmediate();return{logEvent:(s,r,i)=>c0(n,s,r,i)}}catch(n){throw lt.create("interop-component-reg-failed",{reason:n})}}}l0();var u0=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},N,qa=qa||{},B=u0||self;function Kr(){}function _i(t){var e=typeof t;return e=e!="object"?e:t?Array.isArray(t)?"array":e:"null",e=="array"||e=="object"&&typeof t.length=="number"}function Ys(t){var e=typeof t;return e=="object"&&t!=null||e=="function"}function h0(t){return Object.prototype.hasOwnProperty.call(t,yo)&&t[yo]||(t[yo]=++f0)}var yo="closure_uid_"+(1e9*Math.random()>>>0),f0=0;function d0(t,e,n){return t.call.apply(t.bind,arguments)}function p0(t,e,n){if(!t)throw Error();if(2<arguments.length){var s=Array.prototype.slice.call(arguments,2);return function(){var r=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(r,s),t.apply(e,r)}}return function(){return t.apply(e,arguments)}}function qe(t,e,n){return Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?qe=d0:qe=p0,qe.apply(null,arguments)}function Ir(t,e){var n=Array.prototype.slice.call(arguments,1);return function(){var s=n.slice();return s.push.apply(s,arguments),t.apply(this,s)}}function Oe(t,e){function n(){}n.prototype=e.prototype,t.X=e.prototype,t.prototype=new n,t.prototype.constructor=t,t.Wb=function(s,r,i){for(var o=Array(arguments.length-2),a=2;a<arguments.length;a++)o[a-2]=arguments[a];return e.prototype[r].apply(s,o)}}function on(){this.s=this.s,this.o=this.o}var g0=0;on.prototype.s=!1;on.prototype.na=function(){!this.s&&(this.s=!0,this.M(),g0!=0)&&h0(this)};on.prototype.M=function(){if(this.o)for(;this.o.length;)this.o.shift()()};const wf=Array.prototype.indexOf?function(t,e){return Array.prototype.indexOf.call(t,e,void 0)}:function(t,e){if(typeof t=="string")return typeof e!="string"||e.length!=1?-1:t.indexOf(e,0);for(let n=0;n<t.length;n++)if(n in t&&t[n]===e)return n;return-1};function ja(t){const e=t.length;if(0<e){const n=Array(e);for(let s=0;s<e;s++)n[s]=t[s];return n}return[]}function Hl(t,e){for(let n=1;n<arguments.length;n++){const s=arguments[n];if(_i(s)){const r=t.length||0,i=s.length||0;t.length=r+i;for(let o=0;o<i;o++)t[r+o]=s[o]}else t.push(s)}}function je(t,e){this.type=t,this.g=this.target=e,this.defaultPrevented=!1}je.prototype.h=function(){this.defaultPrevented=!0};var m0=function(){if(!B.addEventListener||!Object.defineProperty)return!1;var t=!1,e=Object.defineProperty({},"passive",{get:function(){t=!0}});try{B.addEventListener("test",Kr,e),B.removeEventListener("test",Kr,e)}catch{}return t}();function zr(t){return/^[\s\xa0]*$/.test(t)}var Kl=String.prototype.trim?function(t){return t.trim()}:function(t){return/^[\s\xa0]*([\s\S]*?)[\s\xa0]*$/.exec(t)[1]};function vo(t,e){return t<e?-1:t>e?1:0}function Ci(){var t=B.navigator;return t&&(t=t.userAgent)?t:""}function _t(t){return Ci().indexOf(t)!=-1}function Ha(t){return Ha[" "](t),t}Ha[" "]=Kr;function y0(t){var e=E0;return Object.prototype.hasOwnProperty.call(e,9)?e[9]:e[9]=t(9)}var v0=_t("Opera"),Jn=_t("Trident")||_t("MSIE"),Ef=_t("Edge"),zo=Ef||Jn,If=_t("Gecko")&&!(Ci().toLowerCase().indexOf("webkit")!=-1&&!_t("Edge"))&&!(_t("Trident")||_t("MSIE"))&&!_t("Edge"),w0=Ci().toLowerCase().indexOf("webkit")!=-1&&!_t("Edge");function Tf(){var t=B.document;return t?t.documentMode:void 0}var Gr;e:{var wo="",Eo=function(){var t=Ci();if(If)return/rv:([^\);]+)(\)|;)/.exec(t);if(Ef)return/Edge\/([\d\.]+)/.exec(t);if(Jn)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(t);if(w0)return/WebKit\/(\S+)/.exec(t);if(v0)return/(?:Version)[ \/]?(\S+)/.exec(t)}();if(Eo&&(wo=Eo?Eo[1]:""),Jn){var Io=Tf();if(Io!=null&&Io>parseFloat(wo)){Gr=String(Io);break e}}Gr=wo}var E0={};function I0(){return y0(function(){let t=0;const e=Kl(String(Gr)).split("."),n=Kl("9").split("."),s=Math.max(e.length,n.length);for(let o=0;t==0&&o<s;o++){var r=e[o]||"",i=n[o]||"";do{if(r=/(\d*)(\D*)(.*)/.exec(r)||["","","",""],i=/(\d*)(\D*)(.*)/.exec(i)||["","","",""],r[0].length==0&&i[0].length==0)break;t=vo(r[1].length==0?0:parseInt(r[1],10),i[1].length==0?0:parseInt(i[1],10))||vo(r[2].length==0,i[2].length==0)||vo(r[2],i[2]),r=r[3],i=i[3]}while(t==0)}return 0<=t})}var Go;if(B.document&&Jn){var zl=Tf();Go=zl||parseInt(Gr,10)||void 0}else Go=void 0;var T0=Go;function Vs(t,e){if(je.call(this,t?t.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,t){var n=this.type=t.type,s=t.changedTouches&&t.changedTouches.length?t.changedTouches[0]:null;if(this.target=t.target||t.srcElement,this.g=e,e=t.relatedTarget){if(If){e:{try{Ha(e.nodeName);var r=!0;break e}catch{}r=!1}r||(e=null)}}else n=="mouseover"?e=t.fromElement:n=="mouseout"&&(e=t.toElement);this.relatedTarget=e,s?(this.clientX=s.clientX!==void 0?s.clientX:s.pageX,this.clientY=s.clientY!==void 0?s.clientY:s.pageY,this.screenX=s.screenX||0,this.screenY=s.screenY||0):(this.clientX=t.clientX!==void 0?t.clientX:t.pageX,this.clientY=t.clientY!==void 0?t.clientY:t.pageY,this.screenX=t.screenX||0,this.screenY=t.screenY||0),this.button=t.button,this.key=t.key||"",this.ctrlKey=t.ctrlKey,this.altKey=t.altKey,this.shiftKey=t.shiftKey,this.metaKey=t.metaKey,this.pointerId=t.pointerId||0,this.pointerType=typeof t.pointerType=="string"?t.pointerType:b0[t.pointerType]||"",this.state=t.state,this.i=t,t.defaultPrevented&&Vs.X.h.call(this)}}Oe(Vs,je);var b0={2:"touch",3:"pen",4:"mouse"};Vs.prototype.h=function(){Vs.X.h.call(this);var t=this.i;t.preventDefault?t.preventDefault():t.returnValue=!1};var Xs="closure_listenable_"+(1e6*Math.random()|0),_0=0;function C0(t,e,n,s,r){this.listener=t,this.proxy=null,this.src=e,this.type=n,this.capture=!!s,this.ha=r,this.key=++_0,this.ba=this.ea=!1}function Ai(t){t.ba=!0,t.listener=null,t.proxy=null,t.src=null,t.ha=null}function Ka(t,e,n){for(const s in t)e.call(n,t[s],s,t)}function bf(t){const e={};for(const n in t)e[n]=t[n];return e}const Gl="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function _f(t,e){let n,s;for(let r=1;r<arguments.length;r++){s=arguments[r];for(n in s)t[n]=s[n];for(let i=0;i<Gl.length;i++)n=Gl[i],Object.prototype.hasOwnProperty.call(s,n)&&(t[n]=s[n])}}function Si(t){this.src=t,this.g={},this.h=0}Si.prototype.add=function(t,e,n,s,r){var i=t.toString();t=this.g[i],t||(t=this.g[i]=[],this.h++);var o=Qo(t,e,s,r);return-1<o?(e=t[o],n||(e.ea=!1)):(e=new C0(e,this.src,i,!!s,r),e.ea=n,t.push(e)),e};function Wo(t,e){var n=e.type;if(n in t.g){var s=t.g[n],r=wf(s,e),i;(i=0<=r)&&Array.prototype.splice.call(s,r,1),i&&(Ai(e),t.g[n].length==0&&(delete t.g[n],t.h--))}}function Qo(t,e,n,s){for(var r=0;r<t.length;++r){var i=t[r];if(!i.ba&&i.listener==e&&i.capture==!!n&&i.ha==s)return r}return-1}var za="closure_lm_"+(1e6*Math.random()|0),To={};function Cf(t,e,n,s,r){if(s&&s.once)return Sf(t,e,n,s,r);if(Array.isArray(e)){for(var i=0;i<e.length;i++)Cf(t,e[i],n,s,r);return null}return n=Qa(n),t&&t[Xs]?t.N(e,n,Ys(s)?!!s.capture:!!s,r):Af(t,e,n,!1,s,r)}function Af(t,e,n,s,r,i){if(!e)throw Error("Invalid event type");var o=Ys(r)?!!r.capture:!!r,a=Wa(t);if(a||(t[za]=a=new Si(t)),n=a.add(e,n,s,o,i),n.proxy)return n;if(s=A0(),n.proxy=s,s.src=t,s.listener=n,t.addEventListener)m0||(r=o),r===void 0&&(r=!1),t.addEventListener(e.toString(),s,r);else if(t.attachEvent)t.attachEvent(xf(e.toString()),s);else if(t.addListener&&t.removeListener)t.addListener(s);else throw Error("addEventListener and attachEvent are unavailable.");return n}function A0(){function t(n){return e.call(t.src,t.listener,n)}const e=S0;return t}function Sf(t,e,n,s,r){if(Array.isArray(e)){for(var i=0;i<e.length;i++)Sf(t,e[i],n,s,r);return null}return n=Qa(n),t&&t[Xs]?t.O(e,n,Ys(s)?!!s.capture:!!s,r):Af(t,e,n,!0,s,r)}function Df(t,e,n,s,r){if(Array.isArray(e))for(var i=0;i<e.length;i++)Df(t,e[i],n,s,r);else s=Ys(s)?!!s.capture:!!s,n=Qa(n),t&&t[Xs]?(t=t.i,e=String(e).toString(),e in t.g&&(i=t.g[e],n=Qo(i,n,s,r),-1<n&&(Ai(i[n]),Array.prototype.splice.call(i,n,1),i.length==0&&(delete t.g[e],t.h--)))):t&&(t=Wa(t))&&(e=t.g[e.toString()],t=-1,e&&(t=Qo(e,n,s,r)),(n=-1<t?e[t]:null)&&Ga(n))}function Ga(t){if(typeof t!="number"&&t&&!t.ba){var e=t.src;if(e&&e[Xs])Wo(e.i,t);else{var n=t.type,s=t.proxy;e.removeEventListener?e.removeEventListener(n,s,t.capture):e.detachEvent?e.detachEvent(xf(n),s):e.addListener&&e.removeListener&&e.removeListener(s),(n=Wa(e))?(Wo(n,t),n.h==0&&(n.src=null,e[za]=null)):Ai(t)}}}function xf(t){return t in To?To[t]:To[t]="on"+t}function S0(t,e){if(t.ba)t=!0;else{e=new Vs(e,this);var n=t.listener,s=t.ha||t.src;t.ea&&Ga(t),t=n.call(s,e)}return t}function Wa(t){return t=t[za],t instanceof Si?t:null}var bo="__closure_events_fn_"+(1e9*Math.random()>>>0);function Qa(t){return typeof t=="function"?t:(t[bo]||(t[bo]=function(e){return t.handleEvent(e)}),t[bo])}function De(){on.call(this),this.i=new Si(this),this.P=this,this.I=null}Oe(De,on);De.prototype[Xs]=!0;De.prototype.removeEventListener=function(t,e,n,s){Df(this,t,e,n,s)};function Me(t,e){var n,s=t.I;if(s)for(n=[];s;s=s.I)n.push(s);if(t=t.P,s=e.type||e,typeof e=="string")e=new je(e,t);else if(e instanceof je)e.target=e.target||t;else{var r=e;e=new je(s,t),_f(e,r)}if(r=!0,n)for(var i=n.length-1;0<=i;i--){var o=e.g=n[i];r=Tr(o,s,!0,e)&&r}if(o=e.g=t,r=Tr(o,s,!0,e)&&r,r=Tr(o,s,!1,e)&&r,n)for(i=0;i<n.length;i++)o=e.g=n[i],r=Tr(o,s,!1,e)&&r}De.prototype.M=function(){if(De.X.M.call(this),this.i){var t=this.i,e;for(e in t.g){for(var n=t.g[e],s=0;s<n.length;s++)Ai(n[s]);delete t.g[e],t.h--}}this.I=null};De.prototype.N=function(t,e,n,s){return this.i.add(String(t),e,!1,n,s)};De.prototype.O=function(t,e,n,s){return this.i.add(String(t),e,!0,n,s)};function Tr(t,e,n,s){if(e=t.i.g[String(e)],!e)return!0;e=e.concat();for(var r=!0,i=0;i<e.length;++i){var o=e[i];if(o&&!o.ba&&o.capture==n){var a=o.listener,c=o.ha||o.src;o.ea&&Wo(t.i,o),r=a.call(c,s)!==!1&&r}}return r&&!s.defaultPrevented}var Ya=B.JSON.stringify;function D0(){var t=Rf;let e=null;return t.g&&(e=t.g,t.g=t.g.next,t.g||(t.h=null),e.next=null),e}class x0{constructor(){this.h=this.g=null}add(e,n){const s=Nf.get();s.set(e,n),this.h?this.h.next=s:this.g=s,this.h=s}}var Nf=new class{constructor(t,e){this.i=t,this.j=e,this.h=0,this.g=null}get(){let t;return 0<this.h?(this.h--,t=this.g,this.g=t.next,t.next=null):t=this.i(),t}}(()=>new N0,t=>t.reset());class N0{constructor(){this.next=this.g=this.h=null}set(e,n){this.h=e,this.g=n,this.next=null}reset(){this.next=this.g=this.h=null}}function k0(t){B.setTimeout(()=>{throw t},0)}function kf(t,e){Yo||R0(),Xo||(Yo(),Xo=!0),Rf.add(t,e)}var Yo;function R0(){var t=B.Promise.resolve(void 0);Yo=function(){t.then(M0)}}var Xo=!1,Rf=new x0;function M0(){for(var t;t=D0();){try{t.h.call(t.g)}catch(n){k0(n)}var e=Nf;e.j(t),100>e.h&&(e.h++,t.next=e.g,e.g=t)}Xo=!1}function Di(t,e){De.call(this),this.h=t||1,this.g=e||B,this.j=qe(this.lb,this),this.l=Date.now()}Oe(Di,De);N=Di.prototype;N.ca=!1;N.R=null;N.lb=function(){if(this.ca){var t=Date.now()-this.l;0<t&&t<.8*this.h?this.R=this.g.setTimeout(this.j,this.h-t):(this.R&&(this.g.clearTimeout(this.R),this.R=null),Me(this,"tick"),this.ca&&(Xa(this),this.start()))}};N.start=function(){this.ca=!0,this.R||(this.R=this.g.setTimeout(this.j,this.h),this.l=Date.now())};function Xa(t){t.ca=!1,t.R&&(t.g.clearTimeout(t.R),t.R=null)}N.M=function(){Di.X.M.call(this),Xa(this),delete this.g};function Ja(t,e,n){if(typeof t=="function")n&&(t=qe(t,n));else if(t&&typeof t.handleEvent=="function")t=qe(t.handleEvent,t);else throw Error("Invalid listener argument");return 2147483647<Number(e)?-1:B.setTimeout(t,e||0)}function Mf(t){t.g=Ja(()=>{t.g=null,t.i&&(t.i=!1,Mf(t))},t.j);const e=t.h;t.h=null,t.m.apply(null,e)}class O0 extends on{constructor(e,n){super(),this.m=e,this.j=n,this.h=null,this.i=!1,this.g=null}l(e){this.h=arguments,this.g?this.i=!0:Mf(this)}M(){super.M(),this.g&&(B.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function $s(t){on.call(this),this.h=t,this.g={}}Oe($s,on);var Wl=[];function Of(t,e,n,s){Array.isArray(n)||(n&&(Wl[0]=n.toString()),n=Wl);for(var r=0;r<n.length;r++){var i=Cf(e,n[r],s||t.handleEvent,!1,t.h||t);if(!i)break;t.g[i.key]=i}}function Lf(t){Ka(t.g,function(e,n){this.g.hasOwnProperty(n)&&Ga(e)},t),t.g={}}$s.prototype.M=function(){$s.X.M.call(this),Lf(this)};$s.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};function xi(){this.g=!0}xi.prototype.Aa=function(){this.g=!1};function L0(t,e,n,s,r,i){t.info(function(){if(t.g)if(i)for(var o="",a=i.split("&"),c=0;c<a.length;c++){var l=a[c].split("=");if(1<l.length){var u=l[0];l=l[1];var h=u.split("_");o=2<=h.length&&h[1]=="type"?o+(u+"="+l+"&"):o+(u+"=redacted&")}}else o=null;else o=i;return"XMLHTTP REQ ("+s+") [attempt "+r+"]: "+e+`
`+n+`
`+o})}function F0(t,e,n,s,r,i,o){t.info(function(){return"XMLHTTP RESP ("+s+") [ attempt "+r+"]: "+e+`
`+n+`
`+i+" "+o})}function Bn(t,e,n,s){t.info(function(){return"XMLHTTP TEXT ("+e+"): "+V0(t,n)+(s?" "+s:"")})}function P0(t,e){t.info(function(){return"TIMEOUT: "+e})}xi.prototype.info=function(){};function V0(t,e){if(!t.g)return e;if(!e)return null;try{var n=JSON.parse(e);if(n){for(t=0;t<n.length;t++)if(Array.isArray(n[t])){var s=n[t];if(!(2>s.length)){var r=s[1];if(Array.isArray(r)&&!(1>r.length)){var i=r[0];if(i!="noop"&&i!="stop"&&i!="close")for(var o=1;o<r.length;o++)r[o]=""}}}}return Ya(n)}catch{return e}}var Rn={},Ql=null;function Ni(){return Ql=Ql||new De}Rn.Pa="serverreachability";function Ff(t){je.call(this,Rn.Pa,t)}Oe(Ff,je);function Us(t){const e=Ni();Me(e,new Ff(e))}Rn.STAT_EVENT="statevent";function Pf(t,e){je.call(this,Rn.STAT_EVENT,t),this.stat=e}Oe(Pf,je);function We(t){const e=Ni();Me(e,new Pf(e,t))}Rn.Qa="timingevent";function Vf(t,e){je.call(this,Rn.Qa,t),this.size=e}Oe(Vf,je);function Js(t,e){if(typeof t!="function")throw Error("Fn must not be null and must be a function");return B.setTimeout(function(){t()},e)}var ki={NO_ERROR:0,mb:1,zb:2,yb:3,tb:4,xb:5,Ab:6,Ma:7,TIMEOUT:8,Db:9},$f={rb:"complete",Nb:"success",Na:"error",Ma:"abort",Fb:"ready",Gb:"readystatechange",TIMEOUT:"timeout",Bb:"incrementaldata",Eb:"progress",ub:"downloadprogress",Vb:"uploadprogress"};function Za(){}Za.prototype.h=null;function Yl(t){return t.h||(t.h=t.i())}function Uf(){}var Zs={OPEN:"a",qb:"b",Na:"c",Cb:"d"};function ec(){je.call(this,"d")}Oe(ec,je);function tc(){je.call(this,"c")}Oe(tc,je);var Jo;function Ri(){}Oe(Ri,Za);Ri.prototype.g=function(){return new XMLHttpRequest};Ri.prototype.i=function(){return{}};Jo=new Ri;function er(t,e,n,s){this.l=t,this.j=e,this.m=n,this.U=s||1,this.S=new $s(this),this.O=$0,t=zo?125:void 0,this.T=new Di(t),this.H=null,this.i=!1,this.s=this.A=this.v=this.K=this.F=this.V=this.B=null,this.D=[],this.g=null,this.C=0,this.o=this.u=null,this.Y=-1,this.I=!1,this.N=0,this.L=null,this.$=this.J=this.Z=this.P=!1,this.h=new Bf}function Bf(){this.i=null,this.g="",this.h=!1}var $0=45e3,Zo={},Wr={};N=er.prototype;N.setTimeout=function(t){this.O=t};function ea(t,e,n){t.K=1,t.v=Oi(Ft(e)),t.s=n,t.P=!0,qf(t,null)}function qf(t,e){t.F=Date.now(),tr(t),t.A=Ft(t.v);var n=t.A,s=t.U;Array.isArray(s)||(s=[String(s)]),Yf(n.i,"t",s),t.C=0,n=t.l.H,t.h=new Bf,t.g=yd(t.l,n?e:null,!t.s),0<t.N&&(t.L=new O0(qe(t.La,t,t.g),t.N)),Of(t.S,t.g,"readystatechange",t.ib),e=t.H?bf(t.H):{},t.s?(t.u||(t.u="POST"),e["Content-Type"]="application/x-www-form-urlencoded",t.g.da(t.A,t.u,t.s,e)):(t.u="GET",t.g.da(t.A,t.u,null,e)),Us(),L0(t.j,t.u,t.A,t.m,t.U,t.s)}N.ib=function(t){t=t.target;const e=this.L;e&&Mt(t)==3?e.l():this.La(t)};N.La=function(t){try{if(t==this.g)e:{const u=Mt(this.g);var e=this.g.Ea();const h=this.g.aa();if(!(3>u)&&(u!=3||zo||this.g&&(this.h.h||this.g.fa()||eu(this.g)))){this.I||u!=4||e==7||(e==8||0>=h?Us(3):Us(2)),Mi(this);var n=this.g.aa();this.Y=n;t:if(jf(this)){var s=eu(this.g);t="";var r=s.length,i=Mt(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){wn(this),Ss(this);var o="";break t}this.h.i=new B.TextDecoder}for(e=0;e<r;e++)this.h.h=!0,t+=this.h.i.decode(s[e],{stream:i&&e==r-1});s.splice(0,r),this.h.g+=t,this.C=0,o=this.h.g}else o=this.g.fa();if(this.i=n==200,F0(this.j,this.u,this.A,this.m,this.U,u,n),this.i){if(this.Z&&!this.J){t:{if(this.g){var a,c=this.g;if((a=c.g?c.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!zr(a)){var l=a;break t}}l=null}if(n=l)Bn(this.j,this.m,n,"Initial handshake response via X-HTTP-Initial-Response"),this.J=!0,ta(this,n);else{this.i=!1,this.o=3,We(12),wn(this),Ss(this);break e}}this.P?(Hf(this,u,o),zo&&this.i&&u==3&&(Of(this.S,this.T,"tick",this.hb),this.T.start())):(Bn(this.j,this.m,o,null),ta(this,o)),u==4&&wn(this),this.i&&!this.I&&(u==4?dd(this.l,this):(this.i=!1,tr(this)))}else n==400&&0<o.indexOf("Unknown SID")?(this.o=3,We(12)):(this.o=0,We(13)),wn(this),Ss(this)}}}catch{}finally{}};function jf(t){return t.g?t.u=="GET"&&t.K!=2&&t.l.Da:!1}function Hf(t,e,n){let s=!0,r;for(;!t.I&&t.C<n.length;)if(r=U0(t,n),r==Wr){e==4&&(t.o=4,We(14),s=!1),Bn(t.j,t.m,null,"[Incomplete Response]");break}else if(r==Zo){t.o=4,We(15),Bn(t.j,t.m,n,"[Invalid Chunk]"),s=!1;break}else Bn(t.j,t.m,r,null),ta(t,r);jf(t)&&r!=Wr&&r!=Zo&&(t.h.g="",t.C=0),e!=4||n.length!=0||t.h.h||(t.o=1,We(16),s=!1),t.i=t.i&&s,s?0<n.length&&!t.$&&(t.$=!0,e=t.l,e.g==t&&e.$&&!e.K&&(e.j.info("Great, no buffering proxy detected. Bytes received: "+n.length),cc(e),e.K=!0,We(11))):(Bn(t.j,t.m,n,"[Invalid Chunked Response]"),wn(t),Ss(t))}N.hb=function(){if(this.g){var t=Mt(this.g),e=this.g.fa();this.C<e.length&&(Mi(this),Hf(this,t,e),this.i&&t!=4&&tr(this))}};function U0(t,e){var n=t.C,s=e.indexOf(`
`,n);return s==-1?Wr:(n=Number(e.substring(n,s)),isNaN(n)?Zo:(s+=1,s+n>e.length?Wr:(e=e.substr(s,n),t.C=s+n,e)))}N.cancel=function(){this.I=!0,wn(this)};function tr(t){t.V=Date.now()+t.O,Kf(t,t.O)}function Kf(t,e){if(t.B!=null)throw Error("WatchDog timer not null");t.B=Js(qe(t.gb,t),e)}function Mi(t){t.B&&(B.clearTimeout(t.B),t.B=null)}N.gb=function(){this.B=null;const t=Date.now();0<=t-this.V?(P0(this.j,this.A),this.K!=2&&(Us(),We(17)),wn(this),this.o=2,Ss(this)):Kf(this,this.V-t)};function Ss(t){t.l.G==0||t.I||dd(t.l,t)}function wn(t){Mi(t);var e=t.L;e&&typeof e.na=="function"&&e.na(),t.L=null,Xa(t.T),Lf(t.S),t.g&&(e=t.g,t.g=null,e.abort(),e.na())}function ta(t,e){try{var n=t.l;if(n.G!=0&&(n.g==t||na(n.h,t))){if(!t.J&&na(n.h,t)&&n.G==3){try{var s=n.Fa.g.parse(e)}catch{s=null}if(Array.isArray(s)&&s.length==3){var r=s;if(r[0]==0){e:if(!n.u){if(n.g)if(n.g.F+3e3<t.F)Xr(n),Pi(n);else break e;ac(n),We(18)}}else n.Ba=r[1],0<n.Ba-n.T&&37500>r[2]&&n.L&&n.A==0&&!n.v&&(n.v=Js(qe(n.cb,n),6e3));if(1>=Zf(n.h)&&n.ja){try{n.ja()}catch{}n.ja=void 0}}else En(n,11)}else if((t.J||n.g==t)&&Xr(n),!zr(e))for(r=n.Fa.g.parse(e),e=0;e<r.length;e++){let l=r[e];if(n.T=l[0],l=l[1],n.G==2)if(l[0]=="c"){n.I=l[1],n.ka=l[2];const u=l[3];u!=null&&(n.ma=u,n.j.info("VER="+n.ma));const h=l[4];h!=null&&(n.Ca=h,n.j.info("SVER="+n.Ca));const d=l[5];d!=null&&typeof d=="number"&&0<d&&(s=1.5*d,n.J=s,n.j.info("backChannelRequestTimeoutMs_="+s)),s=n;const g=t.g;if(g){const b=g.g?g.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(b){var i=s.h;i.g||b.indexOf("spdy")==-1&&b.indexOf("quic")==-1&&b.indexOf("h2")==-1||(i.j=i.l,i.g=new Set,i.h&&(nc(i,i.h),i.h=null))}if(s.D){const y=g.g?g.g.getResponseHeader("X-HTTP-Session-Id"):null;y&&(s.za=y,pe(s.F,s.D,y))}}n.G=3,n.l&&n.l.xa(),n.$&&(n.P=Date.now()-t.F,n.j.info("Handshake RTT: "+n.P+"ms")),s=n;var o=t;if(s.sa=md(s,s.H?s.ka:null,s.V),o.J){ed(s.h,o);var a=o,c=s.J;c&&a.setTimeout(c),a.B&&(Mi(a),tr(a)),s.g=o}else hd(s);0<n.i.length&&Vi(n)}else l[0]!="stop"&&l[0]!="close"||En(n,7);else n.G==3&&(l[0]=="stop"||l[0]=="close"?l[0]=="stop"?En(n,7):oc(n):l[0]!="noop"&&n.l&&n.l.wa(l),n.A=0)}}Us(4)}catch{}}function B0(t){if(t.W&&typeof t.W=="function")return t.W();if(typeof Map<"u"&&t instanceof Map||typeof Set<"u"&&t instanceof Set)return Array.from(t.values());if(typeof t=="string")return t.split("");if(_i(t)){for(var e=[],n=t.length,s=0;s<n;s++)e.push(t[s]);return e}e=[],n=0;for(s in t)e[n++]=t[s];return e}function q0(t){if(t.oa&&typeof t.oa=="function")return t.oa();if(!t.W||typeof t.W!="function"){if(typeof Map<"u"&&t instanceof Map)return Array.from(t.keys());if(!(typeof Set<"u"&&t instanceof Set)){if(_i(t)||typeof t=="string"){var e=[];t=t.length;for(var n=0;n<t;n++)e.push(n);return e}e=[],n=0;for(const s in t)e[n++]=s;return e}}}function zf(t,e){if(t.forEach&&typeof t.forEach=="function")t.forEach(e,void 0);else if(_i(t)||typeof t=="string")Array.prototype.forEach.call(t,e,void 0);else for(var n=q0(t),s=B0(t),r=s.length,i=0;i<r;i++)e.call(void 0,s[i],n&&n[i],t)}var Gf=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function j0(t,e){if(t){t=t.split("&");for(var n=0;n<t.length;n++){var s=t[n].indexOf("="),r=null;if(0<=s){var i=t[n].substring(0,s);r=t[n].substring(s+1)}else i=t[n];e(i,r?decodeURIComponent(r.replace(/\+/g," ")):"")}}}function _n(t,e){if(this.g=this.s=this.j="",this.m=null,this.o=this.l="",this.h=!1,t instanceof _n){this.h=e!==void 0?e:t.h,Qr(this,t.j),this.s=t.s,this.g=t.g,Yr(this,t.m),this.l=t.l,e=t.i;var n=new Bs;n.i=e.i,e.g&&(n.g=new Map(e.g),n.h=e.h),Xl(this,n),this.o=t.o}else t&&(n=String(t).match(Gf))?(this.h=!!e,Qr(this,n[1]||"",!0),this.s=ws(n[2]||""),this.g=ws(n[3]||"",!0),Yr(this,n[4]),this.l=ws(n[5]||"",!0),Xl(this,n[6]||"",!0),this.o=ws(n[7]||"")):(this.h=!!e,this.i=new Bs(null,this.h))}_n.prototype.toString=function(){var t=[],e=this.j;e&&t.push(Es(e,Jl,!0),":");var n=this.g;return(n||e=="file")&&(t.push("//"),(e=this.s)&&t.push(Es(e,Jl,!0),"@"),t.push(encodeURIComponent(String(n)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),n=this.m,n!=null&&t.push(":",String(n))),(n=this.l)&&(this.g&&n.charAt(0)!="/"&&t.push("/"),t.push(Es(n,n.charAt(0)=="/"?z0:K0,!0))),(n=this.i.toString())&&t.push("?",n),(n=this.o)&&t.push("#",Es(n,W0)),t.join("")};function Ft(t){return new _n(t)}function Qr(t,e,n){t.j=n?ws(e,!0):e,t.j&&(t.j=t.j.replace(/:$/,""))}function Yr(t,e){if(e){if(e=Number(e),isNaN(e)||0>e)throw Error("Bad port number "+e);t.m=e}else t.m=null}function Xl(t,e,n){e instanceof Bs?(t.i=e,Q0(t.i,t.h)):(n||(e=Es(e,G0)),t.i=new Bs(e,t.h))}function pe(t,e,n){t.i.set(e,n)}function Oi(t){return pe(t,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),t}function ws(t,e){return t?e?decodeURI(t.replace(/%25/g,"%2525")):decodeURIComponent(t):""}function Es(t,e,n){return typeof t=="string"?(t=encodeURI(t).replace(e,H0),n&&(t=t.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),t):null}function H0(t){return t=t.charCodeAt(0),"%"+(t>>4&15).toString(16)+(t&15).toString(16)}var Jl=/[#\/\?@]/g,K0=/[#\?:]/g,z0=/[#\?]/g,G0=/[#\?@]/g,W0=/#/g;function Bs(t,e){this.h=this.g=null,this.i=t||null,this.j=!!e}function an(t){t.g||(t.g=new Map,t.h=0,t.i&&j0(t.i,function(e,n){t.add(decodeURIComponent(e.replace(/\+/g," ")),n)}))}N=Bs.prototype;N.add=function(t,e){an(this),this.i=null,t=ls(this,t);var n=this.g.get(t);return n||this.g.set(t,n=[]),n.push(e),this.h+=1,this};function Wf(t,e){an(t),e=ls(t,e),t.g.has(e)&&(t.i=null,t.h-=t.g.get(e).length,t.g.delete(e))}function Qf(t,e){return an(t),e=ls(t,e),t.g.has(e)}N.forEach=function(t,e){an(this),this.g.forEach(function(n,s){n.forEach(function(r){t.call(e,r,s,this)},this)},this)};N.oa=function(){an(this);const t=Array.from(this.g.values()),e=Array.from(this.g.keys()),n=[];for(let s=0;s<e.length;s++){const r=t[s];for(let i=0;i<r.length;i++)n.push(e[s])}return n};N.W=function(t){an(this);let e=[];if(typeof t=="string")Qf(this,t)&&(e=e.concat(this.g.get(ls(this,t))));else{t=Array.from(this.g.values());for(let n=0;n<t.length;n++)e=e.concat(t[n])}return e};N.set=function(t,e){return an(this),this.i=null,t=ls(this,t),Qf(this,t)&&(this.h-=this.g.get(t).length),this.g.set(t,[e]),this.h+=1,this};N.get=function(t,e){return t?(t=this.W(t),0<t.length?String(t[0]):e):e};function Yf(t,e,n){Wf(t,e),0<n.length&&(t.i=null,t.g.set(ls(t,e),ja(n)),t.h+=n.length)}N.toString=function(){if(this.i)return this.i;if(!this.g)return"";const t=[],e=Array.from(this.g.keys());for(var n=0;n<e.length;n++){var s=e[n];const i=encodeURIComponent(String(s)),o=this.W(s);for(s=0;s<o.length;s++){var r=i;o[s]!==""&&(r+="="+encodeURIComponent(String(o[s]))),t.push(r)}}return this.i=t.join("&")};function ls(t,e){return e=String(e),t.j&&(e=e.toLowerCase()),e}function Q0(t,e){e&&!t.j&&(an(t),t.i=null,t.g.forEach(function(n,s){var r=s.toLowerCase();s!=r&&(Wf(this,s),Yf(this,r,n))},t)),t.j=e}var Y0=class{constructor(e,n){this.h=e,this.g=n}};function Xf(t){this.l=t||X0,B.PerformanceNavigationTiming?(t=B.performance.getEntriesByType("navigation"),t=0<t.length&&(t[0].nextHopProtocol=="hq"||t[0].nextHopProtocol=="h2")):t=!!(B.g&&B.g.Ga&&B.g.Ga()&&B.g.Ga().$b),this.j=t?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}var X0=10;function Jf(t){return t.h?!0:t.g?t.g.size>=t.j:!1}function Zf(t){return t.h?1:t.g?t.g.size:0}function na(t,e){return t.h?t.h==e:t.g?t.g.has(e):!1}function nc(t,e){t.g?t.g.add(e):t.h=e}function ed(t,e){t.h&&t.h==e?t.h=null:t.g&&t.g.has(e)&&t.g.delete(e)}Xf.prototype.cancel=function(){if(this.i=td(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const t of this.g.values())t.cancel();this.g.clear()}};function td(t){if(t.h!=null)return t.i.concat(t.h.D);if(t.g!=null&&t.g.size!==0){let e=t.i;for(const n of t.g.values())e=e.concat(n.D);return e}return ja(t.i)}function sc(){}sc.prototype.stringify=function(t){return B.JSON.stringify(t,void 0)};sc.prototype.parse=function(t){return B.JSON.parse(t,void 0)};function J0(){this.g=new sc}function Z0(t,e,n){const s=n||"";try{zf(t,function(r,i){let o=r;Ys(r)&&(o=Ya(r)),e.push(s+i+"="+encodeURIComponent(o))})}catch(r){throw e.push(s+"type="+encodeURIComponent("_badmap")),r}}function eE(t,e){const n=new xi;if(B.Image){const s=new Image;s.onload=Ir(br,n,s,"TestLoadImage: loaded",!0,e),s.onerror=Ir(br,n,s,"TestLoadImage: error",!1,e),s.onabort=Ir(br,n,s,"TestLoadImage: abort",!1,e),s.ontimeout=Ir(br,n,s,"TestLoadImage: timeout",!1,e),B.setTimeout(function(){s.ontimeout&&s.ontimeout()},1e4),s.src=t}else e(!1)}function br(t,e,n,s,r){try{e.onload=null,e.onerror=null,e.onabort=null,e.ontimeout=null,r(s)}catch{}}function nr(t){this.l=t.ac||null,this.j=t.jb||!1}Oe(nr,Za);nr.prototype.g=function(){return new Li(this.l,this.j)};nr.prototype.i=function(t){return function(){return t}}({});function Li(t,e){De.call(this),this.D=t,this.u=e,this.m=void 0,this.readyState=rc,this.status=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.v=new Headers,this.h=null,this.C="GET",this.B="",this.g=!1,this.A=this.j=this.l=null}Oe(Li,De);var rc=0;N=Li.prototype;N.open=function(t,e){if(this.readyState!=rc)throw this.abort(),Error("Error reopening a connection");this.C=t,this.B=e,this.readyState=1,qs(this)};N.send=function(t){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const e={headers:this.v,method:this.C,credentials:this.m,cache:void 0};t&&(e.body=t),(this.D||B).fetch(new Request(this.B,e)).then(this.Wa.bind(this),this.ga.bind(this))};N.abort=function(){this.response=this.responseText="",this.v=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,sr(this)),this.readyState=rc};N.Wa=function(t){if(this.g&&(this.l=t,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=t.headers,this.readyState=2,qs(this)),this.g&&(this.readyState=3,qs(this),this.g)))if(this.responseType==="arraybuffer")t.arrayBuffer().then(this.Ua.bind(this),this.ga.bind(this));else if(typeof B.ReadableStream<"u"&&"body"in t){if(this.j=t.body.getReader(),this.u){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.A=new TextDecoder;nd(this)}else t.text().then(this.Va.bind(this),this.ga.bind(this))};function nd(t){t.j.read().then(t.Ta.bind(t)).catch(t.ga.bind(t))}N.Ta=function(t){if(this.g){if(this.u&&t.value)this.response.push(t.value);else if(!this.u){var e=t.value?t.value:new Uint8Array(0);(e=this.A.decode(e,{stream:!t.done}))&&(this.response=this.responseText+=e)}t.done?sr(this):qs(this),this.readyState==3&&nd(this)}};N.Va=function(t){this.g&&(this.response=this.responseText=t,sr(this))};N.Ua=function(t){this.g&&(this.response=t,sr(this))};N.ga=function(){this.g&&sr(this)};function sr(t){t.readyState=4,t.l=null,t.j=null,t.A=null,qs(t)}N.setRequestHeader=function(t,e){this.v.append(t,e)};N.getResponseHeader=function(t){return this.h&&this.h.get(t.toLowerCase())||""};N.getAllResponseHeaders=function(){if(!this.h)return"";const t=[],e=this.h.entries();for(var n=e.next();!n.done;)n=n.value,t.push(n[0]+": "+n[1]),n=e.next();return t.join(`\r
`)};function qs(t){t.onreadystatechange&&t.onreadystatechange.call(t)}Object.defineProperty(Li.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(t){this.m=t?"include":"same-origin"}});var tE=B.JSON.parse;function ye(t){De.call(this),this.headers=new Map,this.u=t||null,this.h=!1,this.C=this.g=null,this.H="",this.m=0,this.j="",this.l=this.F=this.v=this.D=!1,this.B=0,this.A=null,this.J=sd,this.K=this.L=!1}Oe(ye,De);var sd="",nE=/^https?$/i,sE=["POST","PUT"];N=ye.prototype;N.Ka=function(t){this.L=t};N.da=function(t,e,n,s){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.H+"; newUri="+t);e=e?e.toUpperCase():"GET",this.H=t,this.j="",this.m=0,this.D=!1,this.h=!0,this.g=this.u?this.u.g():Jo.g(),this.C=this.u?Yl(this.u):Yl(Jo),this.g.onreadystatechange=qe(this.Ha,this);try{this.F=!0,this.g.open(e,String(t),!0),this.F=!1}catch(i){Zl(this,i);return}if(t=n||"",n=new Map(this.headers),s)if(Object.getPrototypeOf(s)===Object.prototype)for(var r in s)n.set(r,s[r]);else if(typeof s.keys=="function"&&typeof s.get=="function")for(const i of s.keys())n.set(i,s.get(i));else throw Error("Unknown input type for opt_headers: "+String(s));s=Array.from(n.keys()).find(i=>i.toLowerCase()=="content-type"),r=B.FormData&&t instanceof B.FormData,!(0<=wf(sE,e))||s||r||n.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[i,o]of n)this.g.setRequestHeader(i,o);this.J&&(this.g.responseType=this.J),"withCredentials"in this.g&&this.g.withCredentials!==this.L&&(this.g.withCredentials=this.L);try{od(this),0<this.B&&((this.K=rE(this.g))?(this.g.timeout=this.B,this.g.ontimeout=qe(this.qa,this)):this.A=Ja(this.qa,this.B,this)),this.v=!0,this.g.send(t),this.v=!1}catch(i){Zl(this,i)}};function rE(t){return Jn&&I0()&&typeof t.timeout=="number"&&t.ontimeout!==void 0}N.qa=function(){typeof qa<"u"&&this.g&&(this.j="Timed out after "+this.B+"ms, aborting",this.m=8,Me(this,"timeout"),this.abort(8))};function Zl(t,e){t.h=!1,t.g&&(t.l=!0,t.g.abort(),t.l=!1),t.j=e,t.m=5,rd(t),Fi(t)}function rd(t){t.D||(t.D=!0,Me(t,"complete"),Me(t,"error"))}N.abort=function(t){this.g&&this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1,this.m=t||7,Me(this,"complete"),Me(this,"abort"),Fi(this))};N.M=function(){this.g&&(this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1),Fi(this,!0)),ye.X.M.call(this)};N.Ha=function(){this.s||(this.F||this.v||this.l?id(this):this.fb())};N.fb=function(){id(this)};function id(t){if(t.h&&typeof qa<"u"&&(!t.C[1]||Mt(t)!=4||t.aa()!=2)){if(t.v&&Mt(t)==4)Ja(t.Ha,0,t);else if(Me(t,"readystatechange"),Mt(t)==4){t.h=!1;try{const a=t.aa();e:switch(a){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var e=!0;break e;default:e=!1}var n;if(!(n=e)){var s;if(s=a===0){var r=String(t.H).match(Gf)[1]||null;if(!r&&B.self&&B.self.location){var i=B.self.location.protocol;r=i.substr(0,i.length-1)}s=!nE.test(r?r.toLowerCase():"")}n=s}if(n)Me(t,"complete"),Me(t,"success");else{t.m=6;try{var o=2<Mt(t)?t.g.statusText:""}catch{o=""}t.j=o+" ["+t.aa()+"]",rd(t)}}finally{Fi(t)}}}}function Fi(t,e){if(t.g){od(t);const n=t.g,s=t.C[0]?Kr:null;t.g=null,t.C=null,e||Me(t,"ready");try{n.onreadystatechange=s}catch{}}}function od(t){t.g&&t.K&&(t.g.ontimeout=null),t.A&&(B.clearTimeout(t.A),t.A=null)}function Mt(t){return t.g?t.g.readyState:0}N.aa=function(){try{return 2<Mt(this)?this.g.status:-1}catch{return-1}};N.fa=function(){try{return this.g?this.g.responseText:""}catch{return""}};N.Sa=function(t){if(this.g){var e=this.g.responseText;return t&&e.indexOf(t)==0&&(e=e.substring(t.length)),tE(e)}};function eu(t){try{if(!t.g)return null;if("response"in t.g)return t.g.response;switch(t.J){case sd:case"text":return t.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in t.g)return t.g.mozResponseArrayBuffer}return null}catch{return null}}N.Ea=function(){return this.m};N.Oa=function(){return typeof this.j=="string"?this.j:String(this.j)};function ad(t){let e="";return Ka(t,function(n,s){e+=s,e+=":",e+=n,e+=`\r
`}),e}function ic(t,e,n){e:{for(s in n){var s=!1;break e}s=!0}s||(n=ad(n),typeof t=="string"?n!=null&&encodeURIComponent(String(n)):pe(t,e,n))}function ys(t,e,n){return n&&n.internalChannelParams&&n.internalChannelParams[t]||e}function cd(t){this.Ca=0,this.i=[],this.j=new xi,this.ka=this.sa=this.F=this.V=this.g=this.za=this.D=this.ia=this.o=this.S=this.s=null,this.ab=this.U=0,this.Za=ys("failFast",!1,t),this.L=this.v=this.u=this.m=this.l=null,this.Y=!0,this.pa=this.Ba=this.T=-1,this.Z=this.A=this.C=0,this.Xa=ys("baseRetryDelayMs",5e3,t),this.bb=ys("retryDelaySeedMs",1e4,t),this.$a=ys("forwardChannelMaxRetries",2,t),this.ta=ys("forwardChannelRequestTimeoutMs",2e4,t),this.ra=t&&t.xmlHttpFactory||void 0,this.Da=t&&t.Zb||!1,this.J=void 0,this.H=t&&t.supportsCrossDomainXhr||!1,this.I="",this.h=new Xf(t&&t.concurrentRequestLimit),this.Fa=new J0,this.O=t&&t.fastHandshake||!1,this.N=t&&t.encodeInitMessageHeaders||!1,this.O&&this.N&&(this.N=!1),this.Ya=t&&t.Xb||!1,t&&t.Aa&&this.j.Aa(),t&&t.forceLongPolling&&(this.Y=!1),this.$=!this.O&&this.Y&&t&&t.detectBufferingProxy||!1,this.ja=void 0,this.P=0,this.K=!1,this.la=this.B=null}N=cd.prototype;N.ma=8;N.G=1;function oc(t){if(ld(t),t.G==3){var e=t.U++,n=Ft(t.F);pe(n,"SID",t.I),pe(n,"RID",e),pe(n,"TYPE","terminate"),rr(t,n),e=new er(t,t.j,e,void 0),e.K=2,e.v=Oi(Ft(n)),n=!1,B.navigator&&B.navigator.sendBeacon&&(n=B.navigator.sendBeacon(e.v.toString(),"")),!n&&B.Image&&(new Image().src=e.v,n=!0),n||(e.g=yd(e.l,null),e.g.da(e.v)),e.F=Date.now(),tr(e)}gd(t)}function Pi(t){t.g&&(cc(t),t.g.cancel(),t.g=null)}function ld(t){Pi(t),t.u&&(B.clearTimeout(t.u),t.u=null),Xr(t),t.h.cancel(),t.m&&(typeof t.m=="number"&&B.clearTimeout(t.m),t.m=null)}function Vi(t){Jf(t.h)||t.m||(t.m=!0,kf(t.Ja,t),t.C=0)}function iE(t,e){return Zf(t.h)>=t.h.j-(t.m?1:0)?!1:t.m?(t.i=e.D.concat(t.i),!0):t.G==1||t.G==2||t.C>=(t.Za?0:t.$a)?!1:(t.m=Js(qe(t.Ja,t,e),pd(t,t.C)),t.C++,!0)}N.Ja=function(t){if(this.m)if(this.m=null,this.G==1){if(!t){this.U=Math.floor(1e5*Math.random()),t=this.U++;const r=new er(this,this.j,t,void 0);let i=this.s;if(this.S&&(i?(i=bf(i),_f(i,this.S)):i=this.S),this.o!==null||this.N||(r.H=i,i=null),this.O)e:{for(var e=0,n=0;n<this.i.length;n++){t:{var s=this.i[n];if("__data__"in s.g&&(s=s.g.__data__,typeof s=="string")){s=s.length;break t}s=void 0}if(s===void 0)break;if(e+=s,4096<e){e=n;break e}if(e===4096||n===this.i.length-1){e=n+1;break e}}e=1e3}else e=1e3;e=ud(this,r,e),n=Ft(this.F),pe(n,"RID",t),pe(n,"CVER",22),this.D&&pe(n,"X-HTTP-Session-Id",this.D),rr(this,n),i&&(this.N?e="headers="+encodeURIComponent(String(ad(i)))+"&"+e:this.o&&ic(n,this.o,i)),nc(this.h,r),this.Ya&&pe(n,"TYPE","init"),this.O?(pe(n,"$req",e),pe(n,"SID","null"),r.Z=!0,ea(r,n,null)):ea(r,n,e),this.G=2}}else this.G==3&&(t?tu(this,t):this.i.length==0||Jf(this.h)||tu(this))};function tu(t,e){var n;e?n=e.m:n=t.U++;const s=Ft(t.F);pe(s,"SID",t.I),pe(s,"RID",n),pe(s,"AID",t.T),rr(t,s),t.o&&t.s&&ic(s,t.o,t.s),n=new er(t,t.j,n,t.C+1),t.o===null&&(n.H=t.s),e&&(t.i=e.D.concat(t.i)),e=ud(t,n,1e3),n.setTimeout(Math.round(.5*t.ta)+Math.round(.5*t.ta*Math.random())),nc(t.h,n),ea(n,s,e)}function rr(t,e){t.ia&&Ka(t.ia,function(n,s){pe(e,s,n)}),t.l&&zf({},function(n,s){pe(e,s,n)})}function ud(t,e,n){n=Math.min(t.i.length,n);var s=t.l?qe(t.l.Ra,t.l,t):null;e:{var r=t.i;let i=-1;for(;;){const o=["count="+n];i==-1?0<n?(i=r[0].h,o.push("ofs="+i)):i=0:o.push("ofs="+i);let a=!0;for(let c=0;c<n;c++){let l=r[c].h;const u=r[c].g;if(l-=i,0>l)i=Math.max(0,r[c].h-100),a=!1;else try{Z0(u,o,"req"+l+"_")}catch{s&&s(u)}}if(a){s=o.join("&");break e}}}return t=t.i.splice(0,n),e.D=t,s}function hd(t){t.g||t.u||(t.Z=1,kf(t.Ia,t),t.A=0)}function ac(t){return t.g||t.u||3<=t.A?!1:(t.Z++,t.u=Js(qe(t.Ia,t),pd(t,t.A)),t.A++,!0)}N.Ia=function(){if(this.u=null,fd(this),this.$&&!(this.K||this.g==null||0>=this.P)){var t=2*this.P;this.j.info("BP detection timer enabled: "+t),this.B=Js(qe(this.eb,this),t)}};N.eb=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.L=!1,this.K=!0,We(10),Pi(this),fd(this))};function cc(t){t.B!=null&&(B.clearTimeout(t.B),t.B=null)}function fd(t){t.g=new er(t,t.j,"rpc",t.Z),t.o===null&&(t.g.H=t.s),t.g.N=0;var e=Ft(t.sa);pe(e,"RID","rpc"),pe(e,"SID",t.I),pe(e,"CI",t.L?"0":"1"),pe(e,"AID",t.T),pe(e,"TYPE","xmlhttp"),rr(t,e),t.o&&t.s&&ic(e,t.o,t.s),t.J&&t.g.setTimeout(t.J);var n=t.g;t=t.ka,n.K=1,n.v=Oi(Ft(e)),n.s=null,n.P=!0,qf(n,t)}N.cb=function(){this.v!=null&&(this.v=null,Pi(this),ac(this),We(19))};function Xr(t){t.v!=null&&(B.clearTimeout(t.v),t.v=null)}function dd(t,e){var n=null;if(t.g==e){Xr(t),cc(t),t.g=null;var s=2}else if(na(t.h,e))n=e.D,ed(t.h,e),s=1;else return;if(t.G!=0){if(t.pa=e.Y,e.i)if(s==1){n=e.s?e.s.length:0,e=Date.now()-e.F;var r=t.C;s=Ni(),Me(s,new Vf(s,n)),Vi(t)}else hd(t);else if(r=e.o,r==3||r==0&&0<t.pa||!(s==1&&iE(t,e)||s==2&&ac(t)))switch(n&&0<n.length&&(e=t.h,e.i=e.i.concat(n)),r){case 1:En(t,5);break;case 4:En(t,10);break;case 3:En(t,6);break;default:En(t,2)}}}function pd(t,e){let n=t.Xa+Math.floor(Math.random()*t.bb);return t.l||(n*=2),n*e}function En(t,e){if(t.j.info("Error code "+e),e==2){var n=null;t.l&&(n=null);var s=qe(t.kb,t);n||(n=new _n("//www.google.com/images/cleardot.gif"),B.location&&B.location.protocol=="http"||Qr(n,"https"),Oi(n)),eE(n.toString(),s)}else We(2);t.G=0,t.l&&t.l.va(e),gd(t),ld(t)}N.kb=function(t){t?(this.j.info("Successfully pinged google.com"),We(2)):(this.j.info("Failed to ping google.com"),We(1))};function gd(t){if(t.G=0,t.la=[],t.l){const e=td(t.h);(e.length!=0||t.i.length!=0)&&(Hl(t.la,e),Hl(t.la,t.i),t.h.i.length=0,ja(t.i),t.i.length=0),t.l.ua()}}function md(t,e,n){var s=n instanceof _n?Ft(n):new _n(n,void 0);if(s.g!="")e&&(s.g=e+"."+s.g),Yr(s,s.m);else{var r=B.location;s=r.protocol,e=e?e+"."+r.hostname:r.hostname,r=+r.port;var i=new _n(null,void 0);s&&Qr(i,s),e&&(i.g=e),r&&Yr(i,r),n&&(i.l=n),s=i}return n=t.D,e=t.za,n&&e&&pe(s,n,e),pe(s,"VER",t.ma),rr(t,s),s}function yd(t,e,n){if(e&&!t.H)throw Error("Can't create secondary domain capable XhrIo object.");return e=n&&t.Da&&!t.ra?new ye(new nr({jb:!0})):new ye(t.ra),e.Ka(t.H),e}function vd(){}N=vd.prototype;N.xa=function(){};N.wa=function(){};N.va=function(){};N.ua=function(){};N.Ra=function(){};function Jr(){if(Jn&&!(10<=Number(T0)))throw Error("Environmental error: no available transport.")}Jr.prototype.g=function(t,e){return new st(t,e)};function st(t,e){De.call(this),this.g=new cd(e),this.l=t,this.h=e&&e.messageUrlParams||null,t=e&&e.messageHeaders||null,e&&e.clientProtocolHeaderRequired&&(t?t["X-Client-Protocol"]="webchannel":t={"X-Client-Protocol":"webchannel"}),this.g.s=t,t=e&&e.initMessageHeaders||null,e&&e.messageContentType&&(t?t["X-WebChannel-Content-Type"]=e.messageContentType:t={"X-WebChannel-Content-Type":e.messageContentType}),e&&e.ya&&(t?t["X-WebChannel-Client-Profile"]=e.ya:t={"X-WebChannel-Client-Profile":e.ya}),this.g.S=t,(t=e&&e.Yb)&&!zr(t)&&(this.g.o=t),this.A=e&&e.supportsCrossDomainXhr||!1,this.v=e&&e.sendRawJson||!1,(e=e&&e.httpSessionIdParam)&&!zr(e)&&(this.g.D=e,t=this.h,t!==null&&e in t&&(t=this.h,e in t&&delete t[e])),this.j=new us(this)}Oe(st,De);st.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.H=!0);var t=this.g,e=this.l,n=this.h||void 0;We(0),t.V=e,t.ia=n||{},t.L=t.Y,t.F=md(t,null,t.V),Vi(t)};st.prototype.close=function(){oc(this.g)};st.prototype.u=function(t){var e=this.g;if(typeof t=="string"){var n={};n.__data__=t,t=n}else this.v&&(n={},n.__data__=Ya(t),t=n);e.i.push(new Y0(e.ab++,t)),e.G==3&&Vi(e)};st.prototype.M=function(){this.g.l=null,delete this.j,oc(this.g),delete this.g,st.X.M.call(this)};function wd(t){ec.call(this);var e=t.__sm__;if(e){e:{for(const n in e){t=n;break e}t=void 0}(this.i=t)&&(t=this.i,e=e!==null&&t in e?e[t]:void 0),this.data=e}else this.data=t}Oe(wd,ec);function Ed(){tc.call(this),this.status=1}Oe(Ed,tc);function us(t){this.g=t}Oe(us,vd);us.prototype.xa=function(){Me(this.g,"a")};us.prototype.wa=function(t){Me(this.g,new wd(t))};us.prototype.va=function(t){Me(this.g,new Ed)};us.prototype.ua=function(){Me(this.g,"b")};Jr.prototype.createWebChannel=Jr.prototype.g;st.prototype.send=st.prototype.u;st.prototype.open=st.prototype.m;st.prototype.close=st.prototype.close;ki.NO_ERROR=0;ki.TIMEOUT=8;ki.HTTP_ERROR=6;$f.COMPLETE="complete";Uf.EventType=Zs;Zs.OPEN="a";Zs.CLOSE="b";Zs.ERROR="c";Zs.MESSAGE="d";De.prototype.listen=De.prototype.N;ye.prototype.listenOnce=ye.prototype.O;ye.prototype.getLastError=ye.prototype.Oa;ye.prototype.getLastErrorCode=ye.prototype.Ea;ye.prototype.getStatus=ye.prototype.aa;ye.prototype.getResponseJson=ye.prototype.Sa;ye.prototype.getResponseText=ye.prototype.fa;ye.prototype.send=ye.prototype.da;ye.prototype.setWithCredentials=ye.prototype.Ka;var oE=function(){return new Jr},aE=function(){return Ni()},_o=ki,cE=$f,lE=Rn,nu={sb:0,vb:1,wb:2,Pb:3,Ub:4,Rb:5,Sb:6,Qb:7,Ob:8,Tb:9,PROXY:10,NOPROXY:11,Mb:12,Ib:13,Jb:14,Hb:15,Kb:16,Lb:17,ob:18,nb:19,pb:20},uE=nr,_r=Uf,hE=ye;const su="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $i(t){return t==null}function Zr(t){return t===0&&1/t==-1/0}function SE(t){return typeof t=="number"&&Number.isInteger(t)&&!Zr(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Je{constructor(e){this.value=e}static empty(){return new Je({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let n=this.value;for(let s=0;s<e.length-1;++s)if(n=(n.mapValue.fields||{})[e.get(s)],!kr(n))return null;return n=(n.mapValue.fields||{})[e.lastSegment()],n||null}}set(e,n){this.getFieldsMap(e.popLast())[e.lastSegment()]=Ds(n)}setAll(e){let n=$e.emptyPath(),s={},r=[];e.forEach((o,a)=>{if(!n.isImmediateParentOf(a)){const c=this.getFieldsMap(n);this.applyChanges(c,s,r),s={},r=[],n=a.popLast()}o?s[a.lastSegment()]=Ds(o):r.push(a.lastSegment())});const i=this.getFieldsMap(n);this.applyChanges(i,s,r)}delete(e){const n=this.field(e.popLast());kr(n)&&n.mapValue.fields&&delete n.mapValue.fields[e.lastSegment()]}isEqual(e){return xt(this.value,e.value)}getFieldsMap(e){let n=this.value;n.mapValue.fields||(n.mapValue={fields:{}});for(let s=0;s<e.length;++s){let r=n.mapValue.fields[e.get(s)];kr(r)&&r.mapValue.fields||(r={mapValue:{fields:{}}},n.mapValue.fields[e.get(s)]=r),n=r}return n.mapValue.fields}applyChanges(e,n,s){Mn(n,(r,i)=>e[r]=i);for(const r of s)delete e[r]}clone(){return new Je(Ds(this.value))}}function Rd(t){const e=[];return Mn(t.fields,(n,s)=>{const r=new $e([n]);if(kr(s)){const i=Rd(s.mapValue).fields;if(i.length===0)e.push(r);else for(const o of i)e.push(r.child(o))}else e.push(r)}),new ut(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fs{constructor(e,n=null,s=[],r=[],i=null,o="F",a=null,c=null){this.path=e,this.collectionGroup=n,this.explicitOrderBy=s,this.filters=r,this.limit=i,this.limitType=o,this.startAt=a,this.endAt=c,this.dt=null,this._t=null,this.startAt,this.endAt}}function BE(t,e,n,s,r,i,o,a){return new fs(t,e,n,s,r,i,o,a)}function pc(t){return new fs(t)}function pu(t){return t.filters.length===0&&t.limit===null&&t.startAt==null&&t.endAt==null&&(t.explicitOrderBy.length===0||t.explicitOrderBy.length===1&&t.explicitOrderBy[0].field.isKeyField())}function gc(t){return t.explicitOrderBy.length>0?t.explicitOrderBy[0].field:null}function Ui(t){for(const e of t.filters){const n=e.getFirstInequalityField();if(n!==null)return n}return null}function Md(t){return t.collectionGroup!==null}function Gn(t){const e=K(t);if(e.dt===null){e.dt=[];const n=Ui(e),s=gc(e);if(n!==null&&s===null)n.isKeyField()||e.dt.push(new zn(n)),e.dt.push(new zn($e.keyField(),"asc"));else{let r=!1;for(const i of e.explicitOrderBy)e.dt.push(i),i.field.isKeyField()&&(r=!0);if(!r){const i=e.explicitOrderBy.length>0?e.explicitOrderBy[e.explicitOrderBy.length-1].dir:"asc";e.dt.push(new zn($e.keyField(),i))}}}return e.dt}function Vt(t){const e=K(t);if(!e._t)if(e.limitType==="F")e._t=du(e.path,e.collectionGroup,Gn(e),e.filters,e.limit,e.startAt,e.endAt);else{const n=[];for(const i of Gn(e)){const o=i.dir==="desc"?"asc":"desc";n.push(new zn(i.field,o))}const s=e.endAt?new ei(e.endAt.position,e.endAt.inclusive):null,r=e.startAt?new ei(e.startAt.position,e.startAt.inclusive):null;e._t=du(e.path,e.collectionGroup,n,e.filters,e.limit,s,r)}return e._t}function aa(t,e){e.getFirstInequalityField(),Ui(t);const n=t.filters.concat([e]);return new fs(t.path,t.collectionGroup,t.explicitOrderBy.slice(),n,t.limit,t.limitType,t.startAt,t.endAt)}function ti(t,e,n){return new fs(t.path,t.collectionGroup,t.explicitOrderBy.slice(),t.filters.slice(),e,n,t.startAt,t.endAt)}function Bi(t,e){return dc(Vt(t),Vt(e))&&t.limitType===e.limitType}function Od(t){return`${fc(Vt(t))}|lt:${t.limitType}`}function ca(t){return`Query(target=${function(e){let n=e.path.canonicalString();return e.collectionGroup!==null&&(n+=" collectionGroup="+e.collectionGroup),e.filters.length>0&&(n+=`, filters: [${e.filters.map(s=>Nd(s)).join(", ")}]`),$i(e.limit)||(n+=", limit: "+e.limit),e.orderBy.length>0&&(n+=`, orderBy: [${e.orderBy.map(s=>function(r){return`${r.field.canonicalString()} (${r.dir})`}(s)).join(", ")}]`),e.startAt&&(n+=", startAt: ",n+=e.startAt.inclusive?"b:":"a:",n+=e.startAt.position.map(s=>ns(s)).join(",")),e.endAt&&(n+=", endAt: ",n+=e.endAt.inclusive?"a:":"b:",n+=e.endAt.position.map(s=>ns(s)).join(",")),`Target(${n})`}(Vt(t))}; limitType=${t.limitType})`}function mc(t,e){return e.isFoundDocument()&&function(n,s){const r=s.key.path;return n.collectionGroup!==null?s.key.hasCollectionId(n.collectionGroup)&&n.path.isPrefixOf(r):O.isDocumentKey(n.path)?n.path.isEqual(r):n.path.isImmediateParentOf(r)}(t,e)&&function(n,s){for(const r of Gn(n))if(!r.field.isKeyField()&&s.data.field(r.field)===null)return!1;return!0}(t,e)&&function(n,s){for(const r of n.filters)if(!r.matches(s))return!1;return!0}(t,e)&&function(n,s){return!(n.startAt&&!function(r,i,o){const a=uu(r,i,o);return r.inclusive?a<=0:a<0}(n.startAt,Gn(n),s)||n.endAt&&!function(r,i,o){const a=uu(r,i,o);return r.inclusive?a>=0:a>0}(n.endAt,Gn(n),s))}(t,e)}function qE(t){return t.collectionGroup||(t.path.length%2==1?t.path.lastSegment():t.path.get(t.path.length-2))}function Ld(t){return(e,n)=>{let s=!1;for(const r of Gn(t)){const i=jE(r,e,n);if(i!==0)return i;s=s||r.field.isKeyField()}return 0}}function jE(t,e,n){const s=t.field.isKeyField()?O.comparator(e.key,n.key):function(r,i,o){const a=i.data.field(r),c=o.data.field(r);return a!==null&&c!==null?ts(a,c):$()}(t.field,e,n);switch(t.dir){case"asc":return s;case"desc":return-1*s;default:return $()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fd(t,e){if(t.wt){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Zr(e)?"-0":e}}function Pd(t){return{integerValue:""+t}}function HE(t,e){return SE(e)?Pd(e):Fd(t,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qi{constructor(){this._=void 0}}function KE(t,e,n){return t instanceof ni?function(s,r){const i={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return r&&(i.fields.__previous_value__=r),{mapValue:i}}(n,e):t instanceof Gs?$d(t,e):t instanceof Ws?Ud(t,e):function(s,r){const i=Vd(s,r),o=gu(i)+gu(s.gt);return ia(i)&&ia(s.gt)?Pd(o):Fd(s.yt,o)}(t,e)}function zE(t,e,n){return t instanceof Gs?$d(t,e):t instanceof Ws?Ud(t,e):n}function Vd(t,e){return t instanceof si?ia(n=e)||function(s){return!!s&&"doubleValue"in s}(n)?e:{integerValue:0}:null;var n}class ni extends qi{}class Gs extends qi{constructor(e){super(),this.elements=e}}function $d(t,e){const n=Bd(e);for(const s of t.elements)n.some(r=>xt(r,s))||n.push(s);return{arrayValue:{values:n}}}class Ws extends qi{constructor(e){super(),this.elements=e}}function Ud(t,e){let n=Bd(e);for(const s of t.elements)n=n.filter(r=>!xt(r,s));return{arrayValue:{values:n}}}class si extends qi{constructor(e,n){super(),this.yt=e,this.gt=n}}function gu(t){return Ee(t.integerValue||t.doubleValue)}function Bd(t){return hc(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}function GE(t,e){return t.field.isEqual(e.field)&&function(n,s){return n instanceof Gs&&s instanceof Gs||n instanceof Ws&&s instanceof Ws?Zn(n.elements,s.elements,xt):n instanceof si&&s instanceof si?xt(n.gt,s.gt):n instanceof ni&&s instanceof ni}(t.transform,e.transform)}class WE{constructor(e,n){this.version=e,this.transformResults=n}}class yt{constructor(e,n){this.updateTime=e,this.exists=n}static none(){return new yt}static exists(e){return new yt(void 0,e)}static updateTime(e){return new yt(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function Rr(t,e){return t.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(t.updateTime):t.exists===void 0||t.exists===e.isFoundDocument()}class ji{}function qd(t,e){if(!t.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return t.isNoDocument()?new yc(t.key,yt.none()):new ar(t.key,t.data,yt.none());{const n=t.data,s=Je.empty();let r=new be($e.comparator);for(let i of e.fields)if(!r.has(i)){let o=n.field(i);o===null&&i.length>1&&(i=i.popLast(),o=n.field(i)),o===null?s.delete(i):s.set(i,o),r=r.add(i)}return new cn(t.key,s,new ut(r.toArray()),yt.none())}}function QE(t,e,n){t instanceof ar?function(s,r,i){const o=s.value.clone(),a=yu(s.fieldTransforms,r,i.transformResults);o.setAll(a),r.convertToFoundDocument(i.version,o).setHasCommittedMutations()}(t,e,n):t instanceof cn?function(s,r,i){if(!Rr(s.precondition,r))return void r.convertToUnknownDocument(i.version);const o=yu(s.fieldTransforms,r,i.transformResults),a=r.data;a.setAll(jd(s)),a.setAll(o),r.convertToFoundDocument(i.version,a).setHasCommittedMutations()}(t,e,n):function(s,r,i){r.convertToNoDocument(i.version).setHasCommittedMutations()}(0,e,n)}function xs(t,e,n,s){return t instanceof ar?function(r,i,o,a){if(!Rr(r.precondition,i))return o;const c=r.value.clone(),l=vu(r.fieldTransforms,a,i);return c.setAll(l),i.convertToFoundDocument(i.version,c).setHasLocalMutations(),null}(t,e,n,s):t instanceof cn?function(r,i,o,a){if(!Rr(r.precondition,i))return o;const c=vu(r.fieldTransforms,a,i),l=i.data;return l.setAll(jd(r)),l.setAll(c),i.convertToFoundDocument(i.version,l).setHasLocalMutations(),o===null?null:o.unionWith(r.fieldMask.fields).unionWith(r.fieldTransforms.map(u=>u.field))}(t,e,n,s):function(r,i,o){return Rr(r.precondition,i)?(i.convertToNoDocument(i.version).setHasLocalMutations(),null):o}(t,e,n)}function YE(t,e){let n=null;for(const s of t.fieldTransforms){const r=e.data.field(s.field),i=Vd(s.transform,r||null);i!=null&&(n===null&&(n=Je.empty()),n.set(s.field,i))}return n||null}function mu(t,e){return t.type===e.type&&!!t.key.isEqual(e.key)&&!!t.precondition.isEqual(e.precondition)&&!!function(n,s){return n===void 0&&s===void 0||!(!n||!s)&&Zn(n,s,(r,i)=>GE(r,i))}(t.fieldTransforms,e.fieldTransforms)&&(t.type===0?t.value.isEqual(e.value):t.type!==1||t.data.isEqual(e.data)&&t.fieldMask.isEqual(e.fieldMask))}class ar extends ji{constructor(e,n,s,r=[]){super(),this.key=e,this.value=n,this.precondition=s,this.fieldTransforms=r,this.type=0}getFieldMask(){return null}}class cn extends ji{constructor(e,n,s,r,i=[]){super(),this.key=e,this.data=n,this.fieldMask=s,this.precondition=r,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function jd(t){const e=new Map;return t.fieldMask.fields.forEach(n=>{if(!n.isEmpty()){const s=t.data.field(n);e.set(n,s)}}),e}function yu(t,e,n){const s=new Map;le(t.length===n.length);for(let r=0;r<n.length;r++){const i=t[r],o=i.transform,a=e.data.field(i.field);s.set(i.field,zE(o,a,n[r]))}return s}function vu(t,e,n){const s=new Map;for(const r of t){const i=r.transform,o=n.data.field(r.field);s.set(r.field,KE(i,o,e))}return s}class yc extends ji{constructor(e,n){super(),this.key=e,this.precondition=n,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class XE extends ji{constructor(e,n){super(),this.key=e,this.precondition=n,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hi{constructor(e,n,s,r,i){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=s,this.documentUpdates=r,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,n,s){const r=new Map;return r.set(e,cr.createSynthesizedTargetChangeForCurrentChange(e,n,s)),new Hi(j.min(),r,Wd(),$t(),Q())}}class cr{constructor(e,n,s,r,i){this.resumeToken=e,this.current=n,this.addedDocuments=s,this.modifiedDocuments=r,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,n,s){return new cr(s,n,Q(),Q(),Q())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _I{constructor(e){this.ie=e}}function CI(t){const e=mI({parent:t.parent,structuredQuery:t.structuredQuery});return t.limitType==="LAST"?ti(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yi{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new D(v.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new $e(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
